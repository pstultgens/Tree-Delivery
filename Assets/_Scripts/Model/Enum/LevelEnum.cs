...
public enum LevelEnum
{
    ...
    [SceneName("Test Difficulty Level"),
        ...
        LevelInformation("This level will be a test level designed to test your pre-knowledge on Binary Search Trees. " +
        "After completing this level your performance will determine the difficulty of the game going forward.")]
    Test,

    [SceneName("Easy Level 1"),
        LevelName("Level 1 - Easy"),
        LevelInformation("This level is designed to get you familiarized with only a root node.\n\n" +
        "After completing this level you have learned:\n" +
        "- What a root node is.")]
    Easy1,
    ...
    [SceneName("Easy Level 2"),
        ...
        LevelInformation("This level is designed to get you familiarized with a small tree consisting of a root node and the left child.\n\n" +
        "After completing this level you have learned:\n" +
    ...
    [SceneName("Easy Level 3"),
        ...
        LevelInformation("This level is designed to get you familiarized with a small tree consisting of a root node and the right child.\n\n" +
        "After completing this level you have learned:\n" +
    ...
    [SceneName("Easy Level 4"),
        ...
        LevelInformation("This level is designed to get you familiarized with a small tree consisting of a root node with 2 children.\n\n" +
        "After completing this level you have learned:\n" +
    ...
    [SceneName("Easy Level 5"),
        ...
        LevelInformation("This level is designed to get you familiarized with a small tree consisting of a root node with 2 children where the left child has also children.\n\n" +
        "After completing this level you have learned:\n" +
    ...
    [SceneName("Easy Level 6"),
        ...
        LevelInformation("This level is designed to get you familiarized with a small tree consisting of a root node with 2 children where the right child has also children.\n\n" +
        "After completing this level you have learned:\n" +
    ...
    [SceneName("Easy Level 7"),
        ...
        LevelInformation("This level is designed to get you familiarized with a small tree consisting of a root node with 2 children where the children also have children.\n\n" +
        "After completing this level you have learned:\n" +
    ...
    [SceneName("Hard Level 6"),
        ...
        LevelInformation("This level is designed to get you familiarized with a small tree consisting of a root node with 2 children where the children also have children. " +
        "As some packages have already been delivered, they should be evaluated and possibly rearranged.\n\n" +
        "After completing this level you have learned:\n" +
        "- Rearrange and populate a Binary Search Tree with the correct values")]
    Hard6,

    [SceneName("Hard Level 7"),
        LevelName("Level 14 - Hard"),
        LevelInformation("This level is designed to get you familiarized with a small tree consisting of a root node with 2 children where the children also have children. " +
        "As all packages have already been delivered, they should be evaluated and possibly rearranged.\n\n" +
        "After completing this level you have learned:\n" +
        "- Rearrange and populate a Binary Search Tree with the correct values")]
    Hard7
}
